...
@section('login')
    <div class="col-lg-6 d-flex align-items-center justify-content-center">
        <div class="auth-form-transparent text-start p-3">
            ...
            <form action="{{ url('prosesregister') }}" method="post" class="pt-3">
                @csrf
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend bg-transparent">
                            <span class="input-group-text bg-transparent border-right-0">
                                <i class="mdi mdi-account-outline text-primary py-1"></i>
                            </span>
                        </div>
                        <input type="text" name="name" class="form-control form-control-sm border-left-0"
                            id="" placeholder="Nama" required>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="text-center mt-4 font-weight-light"> Already have an account? <a href="{{ url('login') }}"
